...
2. ¿Qué pasa si colocamos un punto y coma (;) después del final de la expresión de condición de una declaración if? El punto y coma (;) terminaria con la declaración if, lo que causará error si hay otros if.
