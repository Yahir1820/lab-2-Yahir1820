...
2. ¿Qué sucede cuando el usuario ingresa un número que tiene menos de cinco dígitos? ¿Por qué? ¿Cuál es la salida cuando se ingresa 1763? El programa no acepta ese valor, porque no cumple con la condicion del if, si se ingresa 1763 diria: "Ingrese un valor de 5 digitos."
![1763 error](image.png)
